...
class State:
    ...
    def __init__(self,short_name,path_to_parent_dir):        # reporting_units,elections,parties,offices):
        ...
        context_file_list = ['BallotMeasureSelection.txt','Election.txt','ExternalIdentifier.txt','Office.txt','remark.txt','ReportingUnit.txt'] # TODO remove schema_name.txt and alter README.txt
