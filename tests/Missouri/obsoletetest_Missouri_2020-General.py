...
abbr = "MO"
total_pres_votes = 3012436  # total of all votes for US President
cd = 3  # US House congressional district
total_cd_votes = 406961  # total votes in that US House contest in the chosen cd
shd = 1  # state house district
total_shd_votes = -1  # total votes in that State House contest
ssd = 15  # state senate district
total_ssd_votes = 111605  # total votes in that State Senate contest
...
single_county = "Missouri;Cape Girardeau County"  # pick any one from your file, but use internal db name
pres_votes_county = 40386  # total votes for US President in that county
