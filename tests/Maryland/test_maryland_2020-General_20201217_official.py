...
### note: total counts not consistent with other counts in original file
# # # constants - CHANGE THESE!! - use internal db names
election = "2020 General"
jurisdiction = 'Maryland'
abbr = 'MD'
total_pres_votes = 3037031  # total of all votes for US President
cd = 1  # US House congressional district
total_cd_votes = 395524  # total votes in that US House contest in the chosen cd
shd = 0   # state house district
total_shd_votes = 0  # total votes in that State House contest
ssd = 0  # state senate district
...
pres_votes_vote_type = 983985  # total votes for US President of that vote type
county_or_other = 0   # Change this only if results are subdivided by something other than counties
                            #  e.g., 'parish' in LA, 'state-house' in Alaska, 'ward' in Philadelphia
single_county = 0  # pick any one from your file, but use internal db name
pres_votes_county = 0  # total votes for US President in that county
