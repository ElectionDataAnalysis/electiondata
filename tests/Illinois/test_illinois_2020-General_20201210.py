...
abbr = 'IL'
total_pres_votes = 6033744  # total of all votes for US President
cd = 1  # US House congressional district
total_cd_votes = 325123  # total votes in that US House contest in the chosen cd
shd = 1   # state house district
total_shd_votes = 21204  # total votes in that State House contest
ssd = 7  # state senate district
total_ssd_votes = 90009  # total votes in that State Senate contest
single_vote_type = ''  # pick any one with corresponding data in your file, but use internal db name ***NA***
#pres_votes_vote_type =    # total votes for US President of that vote type ***NA***
county_or_other = "county"   # Change this only if results are subdivided by something other than counties
                            #  e.g., 'parish' in LA, 'state-house' in Alaska, 'ward' in Philadelphia
single_county = 'Illinois;Adams County'  # pick any one from your file, but use internal db name
pres_votes_county = 33527  # total votes for US President in that county
