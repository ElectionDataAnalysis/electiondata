...
single_county = 'Tennessee;Anderson County'  # pick any one from your file, but use internal db name
pres_votes_county = 35570  # total votes for US President in that county
