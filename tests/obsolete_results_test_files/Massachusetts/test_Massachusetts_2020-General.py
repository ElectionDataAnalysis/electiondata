...
abbr = "MA"
total_pres_votes = 3658005 - 26603  # total of all votes for US President
cd = 3  # US House congressional district
total_cd_votes = 388210 - 94671  # total votes in that US House contest in the chosen cd
...
single_county = "Massachusetts;Nantucket County"  # pick any one from your file, but use internal db name
pres_votes_county = 7338 - 32  # total votes for US President in that county
