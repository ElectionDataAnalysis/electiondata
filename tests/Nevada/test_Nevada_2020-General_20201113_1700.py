...
jurisdiction = 'Nevada'
abbr = 'NV'
total_pres_votes = 1344091  # total of all votes for US President
cd = 3  # US House congressional district
total_cd_votes = 395111  # total votes in that US House contest in the chosen cd
...
single_county = 'Nevada;Esmeralda County'  # pick any one from your file, but use internal db name
pres_votes_county = 487  # total votes for US President in that county
