...
def test_nc_contest_totals():
    assert check_contest_totals("2018 General", "North Carolina", 'North Carolina;General Assembly House of Representatives District 1') == 27775

def test_nc_count_type_totals():
    assert check_count_type_totals("2018 General", "North Carolina", 'absentee-mail') == 380688
