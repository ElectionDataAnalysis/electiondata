...
abbr = "GA"
total_pres_votes = 4992001  # total of all votes for US President
cd = 7  # US House congressional district
total_cd_votes = 371464  # total votes in that US House contest in the chosen cd
shd = 8  # state house district
total_shd_votes = 35602  # total votes in that State House contest
ssd = 41  # state senate district
total_ssd_votes = 72972  # total votes in that State Senate contest
single_vote_type = "election-day"  # pick any one with corresponding data in your file, but use internal db name
pres_votes_vote_type = 976466  # total votes for US President of that vote type
