...
abbr = "SC"
total_pres_votes = 2513329  # total of all votes for US President
cd = 3  # US House congressional district
total_cd_votes = 333564  # total votes in that US House contest in the chosen cd
shd = 1  # state house district
total_shd_votes = 17535  # total votes in that State House contest
ssd = 15  # state senate district
total_ssd_votes = 65017  # total votes in that State Senate contest
single_vote_type = "absentee-mail"  # pick any one with corresponding data in your file, but use internal db name
pres_votes_vote_type = 438522  # total votes for US President of that vote type
county_or_other = "county"  # Change this only if results are subdivided by something other than counties
#  e.g., 'parish' in LA, 'state-house' in Alaska, 'ward' in Philadelphia
single_county = "South Carolina;Allendale County"  # pick any one from your file, but use internal db name
pres_votes_county = 3593  # total votes for US President in that county
