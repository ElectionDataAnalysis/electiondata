...
abbr = 'AZ'
total_pres_votes = 1672143 + 1661686 + 51465  # total of all votes for US President
cd = 1  # US House congressional district
total_cd_votes = 365178  # total votes in that US House contest in the chosen cd
shd = 1   # state house district
total_shd_votes = 225667  # total votes in that State House contest
# 92058 + 86405 + 47204
ssd = 1  # state senate district
total_ssd_votes = 145775  # total votes in that State Senate contest
single_vote_type = 'early'  # pick any one with corresponding data in your file, but use internal db name
pres_votes_vote_type = 1540846 + 1402370 + 43746  # total votes for US President of that vote type
county_or_other = "county"   # Change this only if results are subdivided by something other than counties
                            #  e.g., 'parish' in LA, 'state-house' in Alaska, 'ward' in Philadelphia
single_county = 'Arizona;Apache County'  # pick any one from your file, but use internal db name
pres_votes_county = 35183 - 11 # total votes for US President in that county
# (kludge: subtract 11 for Howie Hawkins write-in votes not broken out by vote type)
