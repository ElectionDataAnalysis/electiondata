...
total_cd_votes_party2 = 29260   # total votes for Congressional rep in the chosen cd and party
...
pres_votes_county_party1 = 3848  # total votes for US President in that county for party1
