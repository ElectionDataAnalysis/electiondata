...
abbr = 'MI'
total_pres_votes = 5539302  # total of all votes for US President

cd = 2  # US House congressional district
total_cd_votes = 403247  # total votes in that US House contest in the chosen cd
shd = 1   # state house district
total_shd_votes = 39224  # total votes in that State House contest
...
single_county = 'Michigan;Alger County'  # pick any one from your file, but use internal db name
pres_votes_county = 5128  # total votes for US President in that county
