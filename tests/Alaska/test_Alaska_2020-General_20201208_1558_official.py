...
jurisdiction = 'Alaska'
abbr = 'AK'
total_pres_votes = 359530 - 1961  # total of all votes for US President, less unresolved write-ins
...
pres_votes_county = 3511 + 3477 + 216 + 50 + 34 + 24 + 2  # total votes for US President in that county
