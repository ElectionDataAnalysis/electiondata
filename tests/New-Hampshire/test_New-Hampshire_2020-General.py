...
single_county = "New Hampshire;Belknap County"  # pick any one from your file, but use internal db name
pres_votes_county = 38391  # total votes for US President in that county
