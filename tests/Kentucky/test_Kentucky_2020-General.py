...
abbr = 'KY'
total_pres_votes = 1315454 + 750597 + 25339 + 6259 + 3497  # total of all votes for US President
cd = 3  # US House congressional district
total_cd_votes = 134187 + 221005  # total votes in that US House contest in the chosen cd
shd = 1   # state house district
total_shd_votes = 17630  # total votes in that State House contest
ssd = 15  # state senate district
total_ssd_votes = 46777  # total votes in that State Senate contest
...
single_county = 'Kentucky;McCracken County'  # pick any one from your file, but use internal db name
pres_votes_county = 21399 + 10582 + 347 + 83 + 42  # total votes for US President in that county
