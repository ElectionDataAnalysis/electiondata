...
jurisdiction = 'Iowa'
abbr = 'IA'
total_pres_votes = 1690871  # total of all votes for US President
cd = 1  # US House congressional district
total_cd_votes = 413869  # total votes in that US House contest in the chosen cd
shd = 1   # state house district
total_shd_votes = 15579  # total votes in that State House contest
ssd = 2  # state senate district
total_ssd_votes = 26573  # total votes in that State Senate contest
single_vote_type = 'absentee'  # pick any one with corresponding data in your file, but use internal db name
pres_votes_vote_type = 994691  # total votes for US President of that vote type
county_or_other = "county"   # Change this only if results are subdivided by something other than counties
                            #  e.g., 'parish' in LA, 'state-house' in Alaska, 'ward' in Philadelphia
single_county = 'Iowa;Adams County'  # pick any one from your file, but use internal db name
pres_votes_county = 2160  # total votes for US President in that county
