...
abbr = 'WV'
total_pres_votes = 794652 # total of all votes for US President
cd = 1  # US House congressional district
total_cd_votes = 261665  # total votes in that US House contest in the chosen cd
shd = 2   # state house district
total_shd_votes = 7442  # total votes in that State House contest
ssd = 1  # state senate district
total_ssd_votes = 44981  # total votes in that State Senate contest
single_vote_type = 'election-day'  # pick any one with corresponding data in your file, but use internal db name
pres_votes_vote_type = 794652  # total votes for US President of that vote type
county_or_other = "county"   # Change this only if results are subdivided by something other than counties
                            #  e.g., 'parish' in LA, 'state-house' in Alaska, 'ward' in Philadelphia
single_county = 'West Virginia;Boone County'  # pick any one from your file, but use internal db name
pres_votes_county = 9012  # total votes for US President in that county
