...
abbr = 'MS'
total_pres_votes = 1313759  # total of all votes for US President
cd = 1  # US House congressional district
total_cd_votes = 332795  # total votes in that US House contest in the chosen cd
...
single_county = 'Mississippi;Adams County'  # pick any one from your file, but use internal db name
pres_votes_county = 13759  # total votes for US President in that county
